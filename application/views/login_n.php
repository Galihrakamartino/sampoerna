		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="#">
			  		Sampoerna
			  		<img src="<?php echo BASE_URL('images/logo SIS.png') ?>" width= 100; height = 100;>
			  	</a>
							...
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-primary pull-right">Login</button>
									  <a href="<?php echo base_url('index.php/main') ?>"><button type="button" class="btn btn-success">Back</button></a> 
								</div>
							</div>
						</div>
