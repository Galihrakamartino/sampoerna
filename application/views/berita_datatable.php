					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Forms List Berita</h3>
							</div>
							<div class="module-body">
								<div align="right">
									<a href="<?php echo base_url('index.php/berita/insert/');?>"><button type="button" class="btn btn-success">Tambah Berita</button></a> 
								
								</div>
								<div class="module-body table">
									<table border="1" class="w3-table-all" id="tablepeg">
										<thead>
											<tr><th>No</th><th>Judul Berita</th><th>Isi Berita</th><th>Tanggal Berita</th><th>Foto</th><th>Action</th></tr>
										</thead>
										...
										<tbody>
											...
											foreach ($berita as $f){
												...
												if ($f->foto != null) {
													...
													echo "<img src='".base_url('images/news.jpeg')."'\>";
												}


												echo "</div></td><td> ";?>

												<a href="<?php echo base_url('index.php/berita/edit/'); echo $f->id_berita; ?>"><button type="button" class="btn btn-warning"> Edit</button></a><br> <br>
												<a href="<?php echo base_url('index.php/berita/hapus/'); echo $f->id_berita; ?>" class="btn btn-danger"> Hapus</a></td> 
												</tr>
											<?php $no++; }
											?>
										</tbody>
