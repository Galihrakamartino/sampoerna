					...
					<div class="content">
						...
						<div class="module">
							...
							<br />
								<div>
									<center>
										<font size="5">Apakah Anda yakin ingin menghapus Machine ini ?</font>
									</center>
								</div>
								<br>
								<br>
								...
								<div>
										<center>
											<font size="3" color="black">ID Equipment</font><br><br>
											<font size="5"><?php echo $machine[0]->id_equipment; ?></font>
										</center>
									</div>
									<br>
									<br>
									<div>
										<center>
											...
											<font size="5"><?php echo $machine[0]->nama_machine; ?></font>
										</center>
									</div>
									<br>
									<br>
									<div>
										<center>
											...
											<font size="5"><?php echo $machine[0]->type_machine; ?></font>
										</center>
									</div>
									<br>
									<br>
									<div>
										<center>
											<font size="3" color="black">Deskripsi Machine</font><br><br>
											<font size="5"><?php echo $machine[0]->nama_unit; ?></font>
										</center>
									</div>
									<div>
										...
										<?php echo form_open('machine/hapus/'.$this->uri->segment(3)); ?>
										<div class="control-group">
											<div class="controls">
												<input type="hidden" id="basicinput" name="idequipment" value="<?php echo $this->uri->segment(3); ?>" class="span8">
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
