					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<?php 
 						echo form_open('kepegawaian/edit/'.$this->uri->segment(3));
 						...
 						<?php } ?>
										...
										<div class="control-group">
											...
											<select class="form-control select2" name="level">
													...
													<option value="superadmin" <?php if ($pegawai2[0]->level == 'superadmin') {
														echo "selected";
													}?>>superadmin</option>
													<option value="supervisor" <?php if ($pegawai2[0]->level == 'supervisor') {
														echo "selected";
													}?>>supervisor</option>
													<option value="admin" <?php if ($pegawai2[0]->level == 'admin') {
														echo "selected";
													}?>>admin</option>
													<option value="user" <?php if ($pegawai2[0]->level == 'user') {
														echo "selected";
													}?>>user</option>
