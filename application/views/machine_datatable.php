					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Forms List Machine</h3>
							</div>
							<div class="module-body">
								<div align="right">
									<a href="<?php echo base_url('index.php/machine/insert/');?>"><button type="button" class="btn btn-success">Tambah Machine</button></a> 
								
								</div>
								<div class="module-body table">
									<table border="1" class="w3-table-all" id="tablepeg">
										<thead>
											<tr><th>No</th><th>Nama Machine</th><th>Type Machine</th><th>ID Equipment</th><th>Nama Unit</th><th>Action</th></tr>
										</thead>
										
										<tbody>
											<?php
											$no = 1;
											foreach ($machine as $f){
												...
												";?>
												<td>
												<a href="<?php echo base_url('index.php/machine/edit/'); echo $f->id_equipment; ?>"><button type="button" class="btn btn-warning"> Edit</button></a><br> <br>
												<a href="<?php echo base_url('index.php/machine/hapus/'); echo $f->id_equipment; ?>" class="btn btn-danger"> Hapus</a></td> 
												</tr>
											<?php $no++; }
											?>
										</tbody>
