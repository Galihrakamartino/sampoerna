					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Forms List Unit</h3>
							</div>
							<div class="module-body">
								<div align="right">
									<a href="<?php echo base_url('index.php/unit/insert/');?>"><button type="button" class="btn btn-success">Tambah Unit</button></a> 
								
								</div>
								<div class="module-body table">
									<table border="1" class="w3-table-all" id="tablepeg">
										<thead>
											<tr><th>No</th><th>Nama Machine</th><th>Nama Unit</th><th>Deskripsi Unit</th><th>Action</th></tr>
										</thead>
										...
										<tbody>
											...
											foreach ($unit as $f){
												...
												<td>$f->nama_unit</td>
												<td>$f->deskripsi_unit</td>
												";?>
												<td>
												<a href="<?php echo base_url('index.php/unit/edit/'); echo $f->id_unit; ?>"><button type="button" class="btn btn-warning"> Edit</button></a><br> <br>
												<a href="<?php echo base_url('index.php/unit/hapus/'); echo $f->id_unit; ?>" class="btn btn-danger"> Hapus</a></td> 
												</tr>
											<?php $no++; }
											?>
										</tbody>
