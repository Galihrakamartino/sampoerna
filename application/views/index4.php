			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center animate-box intro-heading">
						<h2 id="produk"><font style="font-family: 'Rufina';font-size: 50px;">Produk Kami</font></h2>
						<div style="text-align: center;">
							<div class="col-md-12 animate-box">
								<div class="services">	
									<p align="center">Sampoerna memproduksi, memasarkan, dan mendistribusikan rokok di Indonesia, yang meliputi Sigaret Kretek Tangan (SKT) dan Sigaret Kretek Mesin (SKM).
									</p>
									<p align="center">
										Sampoerna juga mendistribusikan produk PT Philip Morris Indonesia (PMID), Marlboro, di Indonesia. Di antara merek rokok kretek Sampoerna adalah Dji Sam Soe, Sampoerna A, Sampoerna Kretek, dan Sampoerna U.
									</p>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-6 animate-box text-center">
						<a class="work-img" style="background-image: url(<?php echo base_url('') ;?>images2/amild.png);">
							<div class="overlay"></div>
							<div class="desc">
								<font size="6"><p>SAMPOERNA A</p></font>
								<h2>Sigaret Kretek Mesin #1</h2>
							</div>
						</a>
					</div>
					<div class="col-md-6 animate-box text-center">
						<a class="work-img" style="background-image: url(<?php echo base_url('') ;?>images2/umild.jpg);">
							<div class="overlay"></div>
							<div class="desc">
								<font size="6"><p>SAMPOERNA U</p></font>
								<h2>Sigaret Kretek Mesin</h2>
							</div>
						</a>
					</div>
					<div class="col-md-6 animate-box text-center">
						<a class="work-img" style="background-image: url(<?php echo base_url('') ;?>images2/marlobro.jpg);">
							<div class="overlay"></div>
							<div class="desc">
								<font size="6"><p>SAMPOERNA MARLBORO</p></font>
								<h2>Sigaret Putih Mesin #1</h2>
							</div>
						</a>
					</a>
				</div>
				<div class="col-md-6 animate-box text-center">
					<a class="work-img" style="background-image: url(<?php echo base_url('') ;?>images2/sampoernahijau.jpg);">
						<div class="overlay"></div>
						<div class="desc">
							<font size="6"><p>SAMPOERNA HIJAU</p></font>
							<h2>Sigaret Kretek Tangan</h2>
						</div>
					</a>
				</div>
				<div class="col-md-6 animate-box text-center">
					<a class="work-img" style="background-image: url(<?php echo base_url('') ;?>images2/djisamsoe.png);">
						<div class="overlay"></div>
						<div class="desc">
							<font size="6"><p>SAMPOERNA DJI SAM SOE</p></font>
							<h2>Sigaret Kretek Tangan #1</h2>
						</div>
					</a>
				</div>
			</div>
