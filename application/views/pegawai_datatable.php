...
<body>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
								<div align="right">
									<a href="<?php echo base_url('index.php/kepegawaian/insert/');?>"><button type="button" class="btn btn-success">Tambah Pegawai</button></a> 
								
								</div>
								<div class="module-body table">
									<table border="1" class="w3-table-all" id="tablepeg">
										<thead>
											<tr><th>No</th><th>Nama Pegawai</th><th>Alamat</th><th>Username</th><th>Level</th><th>Foto</th><th>Action</th></tr>
										</thead>
										...
										<tbody>
											...
											foreach ($pegawai as $f){
												...
												<a href="<?php echo base_url('index.php/kepegawaian/edit/'); echo $f->id_pegawai; ?>"><button type="button" class="btn btn-warning"> Edit</button></a><br> <br>
												<a href="<?php echo base_url('index.php/kepegawaian/hapus/'); echo $f->id_pegawai; ?>" class="btn btn-danger"> Hapus</a></td> 
												</tr>
											<?php $no++; }
											?>
										</tbody>
	...
	<script type="text/javascript">
		$(document).ready( function () {
			$('#tablepeg').DataTable({
				 "dom":' <"search"f><"top">rtl<"bottom"p><"clear">'
				});
		} );
	</script>
