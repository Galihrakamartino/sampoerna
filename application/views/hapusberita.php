					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
								...
								<div>
									<center>
										<font size="5">Apakah Anda yakin ingin menghapus Berita ini ?</font>
									</center>
								</div>
								<br>
								<br>
								...
								<div>
									<center>
										<?php 
										if ($berita[0]->foto != null) { ?>
										<img src='<?php echo base_url('uploads/'); echo $berita[0]->foto; ?>' width='200px'>
										<?php } else { ?>
										<img src='<?php echo base_url('images/news.jpeg'); ?>' width='200px'>
										<?php } ?><br><br>

									</div>
									<br><br>
									<div>
											<font size="3" color="black">Judul</font><br><br>
											<font size="5"><?php echo $berita[0]->judul; ?></font>
										
									</div>
									<br>
									<div>
											<font size="3" color="black">Tanggal Berita</font><br><br>
											<font size="5"><?php echo $berita[0]->tanggal; ?></font>
									...
									<div>
										...
										<?php echo form_open('berita/hapus/'.$this->uri->segment(3)); ?>
										<div class="control-group">
											<div class="controls">
												<input type="hidden" id="basicinput" name="idberita" value="<?php echo $this->uri->segment(3); ?>" class="span8">
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
